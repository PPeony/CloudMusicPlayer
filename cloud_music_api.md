...
|添加音乐进歌单|/list/addMusic|post|均必传<br>{<br>"musicId":123,<br>"musicListId":666}|{<br>"message":"success",<br>"code":200,<br>"data":null<br>}|{<br>&nbsp;&nbsp;&nbsp;&nbsp;"message":"该歌曲已存在于该歌单",<br>&nbsp;&nbsp;&nbsp;&nbsp;"code":400,<br>&nbsp;&nbsp;&nbsp;&nbsp;"data":null<br>}<br>
